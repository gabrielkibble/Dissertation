...
def generate_full_schema_traffic(model, df_original, target_states, samples_per_state=10, 
    ...
    byte_stats = ['TnBPSrcIP', 'TnBPDstIP', 'sbytes', 'dbytes'] 
    # Scale these based on general intensity (Packets)
    pkt_stats = ['TnP_PSrcIP', 'TnP_PDstIP', 'TnP_PerProto', 'TnP_Per_Dport', 
...
# 2. Flag Map (Your Hardcoded Fix + Orphans)
    ...
    final_columns = [
        ...
        'saddr', 'sport', 'daddr', 'dport', 'pkts', 'bytes', 
        'state', 'state_number', 'ltime', 'seq', 'dur', 'mean', 'stddev', 
